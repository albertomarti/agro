   ...
   <nav class="teal">
      ...
      right">arrow_drop_down</i>Cultivo</a>
                          <div class="collapsible-body">
                            <ul>
                              <li class="active"><a href="verProducto.php?id_producto=<?php echo $_GET["id_producto"] ?>" class="collection-item"><i class="material-icons left">assignment</i>Instrucciones de Cultivo</a></li> 
                              <li><a href="asignarPlaga.php?id_producto=<?php echo $_GET["id_producto"] ?>" class="collection-item"><i class="material-icons left">assignment</i>Asignar Plaga</a></li> 
                            </ul>
                          </div>
                      </li>
                    </ul>
...
<div id="contenedor-principal" class="">
  ...
  <div class="row">
    ...
    <div class="col s4  hide-on-small-only">
      <div class="card">
        ...
        <div class="collection">
          <a href="verProducto.php?id_producto=<?php echo $_GET["id_producto"] ?>" class="collection-item active"><i class="material-icons left">assignment</i>Instrucciones de Cultivo</a> 
          <a href="asignarPlaga.php?id_producto=<?php echo $_GET["id_producto"] ?>" class="collection-item"><i class="material-icons left">assignment</i>Asignar Plagas</a> 
        </div>
      </div>
    </div>                 
    <div class="col s12 m8"> 
      ...
      <br>
      <div class="row">
        <h2><p>Instrucciones de Cultivo</p></h2>
        <div class="nuevoItem">
          <div class="container">
            ...
            <div class="row">          
              <div class="col s12">
                <div class="input-field">
                  <textarea id="instruccion" rows="" cols="" class="materialize-textarea"></textarea>
                    <label for="instruccion">Instruccion</label>
                </div>                       
              </div>            
              <div class="nuevoTest">
                <div class="input-field col s12">
                  <input type="button" id="nuevoPaso" value="Agregar" class="btn">
                </div>                      
              </div>              
            </div>
            <div class="row">
                    ...
                    echo '                  
                      <div class="card">
                        ...
                        <div class="card-content">
                          <div class="row">
                            <div class="col s12">
                              <input type="hidden" id="paso'.$fila->id_paso.'" value="'.$fila->descripcion.'">
                              <p><b>'.$i.'</b>. '.$fila->descripcion.'</p>
                              <br>
                              <hr> 
                              <a class="eliminarPaso"><i class="material-icons right" id="'.$fila->id_paso.'">delete</i></a>
                              <a class="verPaso"><i class="material-icons right" id="'.$fila->id_paso.'">update</i></a>
                            </div>
                          </div>
                        </div>  
                      </div>
...
<script type="text/javascript">  
  ...
  $(document).ready(function(){
    $('.tooltipped').tooltip({delay:10});
        ...
        $(".verPaso").click(function(e){
          $("#instruccion").val($("#paso"+e.target.id).val()); 
          $("#idPaso").val(e.target.id); 
          $("#nuevoPaso").val("Actualizar");
     ...
     //   alert($("#idItem").val());
        if ($("#nuevoPaso").val() == "Agregar"){
        
          var des = $("#instruccion").val();
          if (des == ""){
            ...
            var datos=[];
              datos.push({
                "operacion": "crearInstruccion",
                "descripcion": $("#instruccion").val(), 
          ...
          var des = $("#instruccion").val();
          if (des == ""){
              Materialize.toast('Complete los Campos', 1000,'',function(){          
              });
          }else{
            var datos=[];
              datos.push({
                "operacion": "actualizarPaso",
                "descripcion": $("#instruccion").val(), 
                "id_paso": $("#idPaso").val()
              }); 
            var ha = {"datos": datos};    
            ...
            ajax("../servidor/producto_gestion.php", {"json": json}).done(function(info) {
              ...
              if (info) {
                Materialize.toast('Item Actualizado Correctamente', 500,'',function(){
                  location.reload(true);              
                });
              }else{
                Materialize.toast('Error al Actualizar el Item', 500,'',function(){
                  location.reload(true);              
                });
              }
            });
