    ...
    <div class="nav-wrapper">
      ...
      right">arrow_drop_down</i>Calcular Estimado</a>
                          <div class="collapsible-body">
                            <ul>
                              <li class="active"><a href="verCultivo.php?id_cultivo=<?php echo $_GET["id_cultivo"]; ?>" class="collection-item"><i class="material-icons left">assignment</i>Estimado Inicial</a></li> 
                              <li><a href="produccionCultivo.php?id_cultivo=<?php echo $_GET["id_cultivo"]; ?>" class="collection-item"><i class="material-icons left">assignment</i>Datos Finales</a></li> 
                            </ul>
                          </div>
                      </li>
                    </ul>
    ...
    <div class="col s4  hide-on-small-only">
      <div class="card">
        ...
        <div class="collection">
          <a href="verCultivo.php?id_cultivo=<?php echo $_GET["id_cultivo"]; ?>" class="collection-item active"><i class="material-icons left">assignment</i>Estimado Inicial</a> 
          <a href="produccionCultivo.php?id_cultivo=<?php echo $_GET["id_cultivo"]; ?>" class="collection-item"><i class="material-icons left">assignment</i>Datos finales</a> 
        </div>
      </div>
    </div>                 
                ...
                <div class="login center-align">      
                      ...
                      <div class="row container">
                            <div class="input-field col s12 l12 m12 offset-s1">
                              <p class="descripcion" ALIGN="justify">Porcentaje de germinación es una prueba que se utilizar para saber cuántas semillas pueden llegar a germinar después de sembrarse <a href="#modal1" class="waves-effect waves-light modal-trigger">ver mas...</a></p>
                            </div>  
                             <!-- Modal Structure -->
                            <div id="modal1" class="modal">
                              <div class="modal-content">
                                <h2>Porcentaje de Germinación</h2>
                                <p ALIGN="justify" class="descripcion">Porcentaje de germinación es una prueba que se utilizar para saber cuántas semillas pueden llegar a germinar después de sembrarse. Usualmente de eligen 10 semillas y se germinan. El número de semillas germinadas será un aproximado del porcentaje de germinación de la semilla. Por ejemplo, si germinaron 7 semillas de 10. El porcentaje de germinación el del 70%.</p>
                              </div>
                ...
                echo '
                  ...
                  <div class="login center-align">      
                        <div class="row">
                            ...
                            <div class="container">
                              <div class="input-field col s12 l6 m12  offset-s1">
                                <input id="germinacion" name="germinacion"  type="text" value="'.$fila->porcentaje_germinacion.'">
                                <label for="germinacion">% Germinacion</label>
                              </div>   
                              <div class="input-field col s12 l6 m12  offset-s1">
                                <input id="semillas" name="semillas"  type="hidden">
                              ...
                              <div class="input-field col s12 l6 m12  offset-s1">
                                <input id="id_recurso" name="produccion_esperada"  type="hidden" value="'.$fila->id_recurso.'">
                              </div>                                                                                                           
                            </div> 
                        </div>
                        <div class="row container">
                        ...
                        <div class="row">
                            ...
                            <div class="container">
                              <div class="input-field col s12 l6 m12  offset-s1">
                                <input id="hectareas_terreno" name="hectareas_terreno"  type="text" class="validate"  value="'.$fila->terreno_hectareas.'">
                                <label for="hectareas_terreno">Hectareas de Terreno</label>
                              </div> 
                              <div class="input-field col s12 l6 m12  offset-s1">
                                <input id="distancia_lineas" name="distancia_lineas"  type="text" class="validate"  value="'.$fila->distancia_lineas.'">
                                <label for="distancia_lineas">Distancia entre lineas (m)</label>
                              </div> 
                              <div class="input-field col s12 l6 m12 offset-s1">
                                <input id="distancia_semillas" name="distancia_semillas"  type="text" class="validate"  value="'.$fila->distancia_semillas.'">
                                <label for="distancia_semillas">Distancia entre semillas (m)</label>
                              </div>                       
                            </div>                
                        </div>
                        <div class="row">
                            ...
                            <div class="container">
                              <div class="input-field col s12 l6 m12  offset-s1">
                                <input id="estimado_semillas" name="estimado_semillas"  type="text" class="validate" value="'.$fila->semillas_requeridas.'">
                                <label for="estimado_semillas">Semillas Necesarias</label>
                              </div> 
                              <div class="input-field col s12 l6 m12  offset-s1">
                                <input id="estimado_germinar" name="estimado_germinar"  type="text" class="validate"  value="'.$fila->plantas_esperadas.'">
